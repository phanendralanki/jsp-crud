...
<html>
   ...
   try
   {
                                String regno = request.getParameter("fregno");
   String name = request.getParameter("fname");
      ...
      String query = "INSERT INTO student(regno,name,course,phone) VALUES (?,?,?,?)";
...
<h4 style="color:<%= color %>"<%= msg %></h4>
   ...
   <input type="text" name="fregno" class="form-control" id="fregno">
                  </div>
</div>
<div class="form-group">
                 <div  class="col-sm-4"></div>
...
<div class="form-group">
                 <div  class="col-sm-4"></div>
                  <div  class="col-sm-4 mx-auto">
                   <label>Course</label>
   <input type="text" name="fcourse" class="form-control" id="fcourse">
                  </div>
</div>
...
<div class="form-group">
                            ...
                            <div  class="col-sm-4 mx-auto">
                                    <label>Phone</label>
       <input type="text" name="fphone" class="form-control" id="fphone">
                            </div>
</div>
            <br/>
